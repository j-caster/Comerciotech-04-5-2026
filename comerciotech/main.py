...
def menu_clientes(cliente_service):
    ...
    while True:
        ...
        if opcion == "1":
            ...
            # Email (debe tener texto antes del @)
            while True:
            ...
            # Teléfono (solo formato +569XXXXXXXX)
            while True:
                ...
                if not Validator.telefono(telefono):
                    ...
                    print("   No se permiten letras ni otros caracteres.")
                    continue
...
def menu_productos(producto_service):
...
def menu_pedidos(pedido_service, cliente_service, producto_service):
    """Submenú para gestión de pedidos"""
    while True:
        print("\n" + "="*40)
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            menu_productos(producto_service)
        elif opcion == "3":
            menu_pedidos(pedido_service, cliente_service, producto_service)
        elif opcion == "4":
